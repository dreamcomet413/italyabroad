...
Object.extend(Dialog.Box.prototype, {
  ...
  show:function()
    ...
    this.overlay.setStyle({height:(document.viewport.getHeight() + document.viewport.getScrollOffsets().last())+'px', width:'100%'});
    ...
    var e_dims = Element.getDimensions(this.dialog_box);
      ...
      top:scroll_offset + ((document.viewport.getHeight()/2) - (e_dims.height/2) - 250) + 'px'
      // top:'100px'
		});
